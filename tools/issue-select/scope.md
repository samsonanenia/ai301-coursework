...
I am most comfortable with Python, Java, JavaScript/TypeScript, APIs,
backend development, debugging, and security. I have also worked on AI
and full-stack projects, so I like issues where I can understand the
logic, reproduce the problem, and test the fix. I prefer a focused issue
with a clear goal rather than something that requires a large redesign
or major changes across the whole project.
